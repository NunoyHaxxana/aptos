...
mkdir -p $HOME/.aptos
cd $HOME/.aptos
wget -O docker-compose.yaml https://raw.githubusercontent.com/NunoyHaxxana/aptos/main/docker-compose.yaml
wget -O validator.yaml https://raw.githubusercontent.com/NunoyHaxxana/aptos/main/validator.yaml
wget -O fullnode.yaml https://github.com/NunoyHaxxana/aptos/blob/main/fullnode.yaml
